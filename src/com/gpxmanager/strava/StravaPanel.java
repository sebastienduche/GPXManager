...
import static com.gpxmanager.Utils.saveJsonFile;
...
public class StravaPanel extends JPanel implements ITabListener {
  ...
  private final StravaData stravaData;
  ...
  public StravaPanel(StravaConnection stravaConnection, List<Activity> activities, StravaData stravaData) {
    stravaPanel = this;
    ...
    SwingUtilities.invokeLater(() -> {
      ...
      downloadNewActivities.setEnabled(stravaData.hasJsonDataFile());
  ...
  public static void openActivityOnStrava(Activity activity) {
    if (stravaPanel.stravaConnection == null) {
      return;
    }
    try {
  ...
  private static void removeActivityAtRow(Activity oldActivity, int selectedRow) {
    ...
    Utils.saveJsonFile(stravaPanel.activities, stravaPanel.stravaData.getJsonDataFile());
  }
  ...
  private void downloadLatestActivities() {
    ...
    SwingUtilities.invokeLater(() -> {
      ...
      gears = enrichWithGear(activities);
      setActivities(activities);
      saveJsonFile(activities, stravaData.getJsonDataFile());
      populateGearCombo();
...
//    }
  ...
  public StravaData getStravaData() {
    return stravaData;
  }
...
//      }
      ...
      SwingUtilities.invokeLater(() -> {
        ...
        try {
          ...
          Utils.saveJsonFile(currentAthleteActivities, stravaData.getJsonDataFile());
...
//      StravaData existingFile = MyGPXManager.getStravaData();
  ...
  class DownloadActivityAction extends AbstractAction {
    ...
    private void performActivityAction(Activity activityFromStrava) {
      ...
      Utils.saveJsonFile(activities, stravaData.getJsonDataFile());
    }
  }
